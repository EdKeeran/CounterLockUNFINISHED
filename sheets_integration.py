...
def populate_friendly_items():
    """Add friendly item data to Google Sheets."""
    friendly_data = [
        ["Hero Name", "Item Name"],  # Headers
        ["Abrams", "Healbane"],
        ["Abrams", "ToxicBullets"],
        ["Abrams", "MonsterRounds"],
        ["Abrams", "SpiritArmor"],
        ["Abrams", "ExtraStamina"],
        ["Bebop", "ReactiveBarrier"],
        ["Bebop", "DebuffRemover"],
        ["Bebop", "SpiritArmor"],
        ["Bebop", "SuperiorStamina"],
        ["Calico", "SlowingHex"],
        ["Calico", "SuperiorStamina"],
        ["Dynamo", "Knockdown"],
        ["Dynamo", "EtherealShift"],
        ["Dynamo", "Unstoppable"],
        ["Dynamo", "SuperiorStamina"],
        ["Grey Talon", "SpiritArmor"],
        ["Grey Talon", "DebuffReducer"],
        ["Grey Talon", "DebuffRemover"],
        ["Grey Talon", "EtherealShift"],
        ["Grey Talon", "SuperiorStamina"],
        ["Haze", "WarpStone"],
        ["Haze", "ReturnFire"],
        ["Haze", "MetalSkin"],
        ["Haze", "SuperiorStamina"],
        ["Infernus", "DebuffRemover"],
        ["Infernus", "ToxicBullets"],
        ["Infernus", "Healbane"],
        ["Infernus", "SlowingHex"],
    ...
    try:
        ...
        # Clear existing data in FriendlyItems sheet
        sheet.values().clear(
            spreadsheetId=SPREADSHEET_ID,
            range='FriendlyItems!A:B'
        ).execute()
        
        # Add new friendly items data
        body = {
            'values': friendly_data
        }
        result = sheet.values().update(
            spreadsheetId=SPREADSHEET_ID,
            range='FriendlyItems!A1',
            valueInputOption='RAW',
            body=body
        ).execute()
        ...
        print(f"Error updating friendly items data: {str(e)}")
